 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.emsi.org/", wsdlLocation = "http://localhost:9191/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://ws.emsi.org/", "BanqueWS");

...
public class ObjectFactory {
    ...
    private final static QName _ListCompte_QNAME = new QName("http://ws.emsi.org/", "ListCompte");
    private final static QName _ListCompteResponse_QNAME = new QName("http://ws.emsi.org/", "ListCompteResponse");
    private final static QName _Compte_QNAME = new QName("http://ws.emsi.org/", "compte");
    private final static QName _Convert_QNAME = new QName("http://ws.emsi.org/", "convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://ws.emsi.org/", "convertResponse");
    private final static QName _GetCompte_QNAME = new QName("http://ws.emsi.org/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://ws.emsi.org/", "getCompteResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.emsi.org/", name = "ListCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.emsi.org/", name = "ListCompteResponse")
